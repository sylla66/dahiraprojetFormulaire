  ...
  return (
    <div className="admin-page">
      <div className="page-hero mb-4">
        <div>
          <div className="hero-pill"><i className="bi bi-ui-checks"></i> Nouveau formulaire</div>
          <h3 className="mb-2">Créer un formulaire</h3>
          <p className="text-muted mb-0">Définissez un formulaire simple et structuré pour vos événements ou collectes.</p>
        </div>
      </div>
            ...
            <div className="card-body p-4 p-lg-5">
              <form onSubmit={handleSubmit}>
                ...
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h5 className="mb-0"><i className="bi bi-list-task me-2"></i> Champs du formulaire</h5>
                  <button type="button" className="btn btn-outline-primary btn-sm" onClick={addChamp}>
                    <i className="bi bi-plus me-1"></i> Ajouter un champ
                  </button>
                </div>
                ...
                <div className="d-flex gap-2 mt-3">
                  <button type="button" className="btn btn-outline-info flex-fill" onClick={() => setShowPreview(true)} disabled={champs.filter((c) => c.nom && c.label).length === 0}>
                    <i className="bi bi-eye me-2"></i> Aperçu
                  </button>
                  <button type="submit" className="btn btn-primary flex-fill">
                    <i className="bi bi-save me-2"></i> Créer le formulaire
                  </button>
                </div>
              </form>
            </div>
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-header bg-light">
                  <h5 className="modal-title"><i className="bi bi-eye me-2"></i> Aperçu du formulaire</h5>
